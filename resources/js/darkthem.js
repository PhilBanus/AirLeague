...
(function (factory) {
    ...
    */
    ...
    on(window, 'load', function () { return setTimeout(function () { return fastdom.write(function () {
		...
		var $container = "";
		if(storage[keyinverse] === 'light'){
				$container = prepend($body, (" <div class=\"uk-position-absolute uk-position-top-right\"><button type=\"button\" class=\"uk-button uk-button-light uk-dark\" style=\"color: #fff; background: transparent\" data-id=\"dark\"><i class=\"fad fa-sun\"></i></button></div> "));
			}
			else{
				$container = prepend($body, (" <div class=\"uk-position-absolute uk-position-top-right\"><button type=\"button\" class=\"uk-button uk-button-light uk-dark\" style=\"color: #222; background: transparent\" data-id=\"light\"><i class=\"fad fa-moon\"></i></button></div> "));
		}
		...
		var logos = document.getElementsByClassName('uk-logo');
     
		for (var i=0; i < logos.length; i++) {
			if(storage[keyinverse] === 'light'){
				logos[i].src = "images/LogoInverse@4x.png";
			}
			else{
				logos[i].src = "images/Logo@4x.png";
}
		}
        ...
        if (storage[keyinverse]) {
            ...
            css(docEl, 'background', storage[keyinverse] === 'dark' ? '#fff' : '#222');
            addClass($body, ("uk-" + (storage[keyinverse])));
			
			
        }

        on($inverse, 'click', function () {
            storage[keyinverse] = $inverse.getAttribute('data-id');
            location.reload();
        });
